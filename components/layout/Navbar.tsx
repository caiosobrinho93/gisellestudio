...
export function Navbar() {
  ...
  const scrollTo = (id: string) => {
    ...
    if (element) {
      const navHeight = 80; // offset for the fixed navbar
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-bg-primary border-b border-white/5 ${
